/**
 * Session-token verification for the admin console.
 *
...
export const REFRESH_COOKIE = 'saly_admin_refresh';
/** Only super-admins may hold an admin-console session. */
const REQUIRED_ROLE: AuthRole = 'SUPER_ADMIN';
