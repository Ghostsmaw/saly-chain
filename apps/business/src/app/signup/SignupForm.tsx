...
export function SignupForm() {
  ...
  return (
    <form action={formAction} className="flex flex-col gap-4">
      ...
      <Field label="Business name" name="name" autoComplete="organization" placeholder="Acme Inc." icon={<User className="h-4 w-4" />} />
      <Field label="Work email" name="email" type="email" autoComplete="email" required placeholder="you@company.com" icon={<Mail className="h-4 w-4" />} />
