/**
 * Session-token verification for the business dashboard.
 *
...
export const SESSION_COOKIE = 'saly_business_session';
export const REFRESH_COOKIE = 'saly_business_refresh';
/** Only BUSINESS accounts may hold a business-dashboard session. */
const REQUIRED_ROLE: AuthRole = 'BUSINESS';
